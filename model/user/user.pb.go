...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x1f, 0x0a,
	...
	,
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*StreamRequest)(nil),    // 2: user.StreamRequest
	(*StreamResponse)(nil),   // 3: user.StreamResponse
}
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.GreetUser:input_type -> user.GreetingRequest
	2, // 1: user.UserService.FetchData:input_type -> user.StreamRequest
	1, // 2: user.UserService.GreetUser:output_type -> user.GreetingResponse
	3, // 3: user.UserService.FetchData:output_type -> user.StreamResponse
...
type UserServiceClient interface {
	...
	FetchData(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (UserService_FetchDataClient, error)
}
...
func (c *userServiceClient) FetchData(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (UserService_FetchDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &_UserService_serviceDesc.Streams[0], "/user.UserService/FetchData", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceFetchDataClient{stream}
...
type UserService_FetchDataClient interface {
	Recv() (*StreamResponse, error)
	grpc.ClientStream
}

type userServiceFetchDataClient struct {
	grpc.ClientStream
}

func (x *userServiceFetchDataClient) Recv() (*StreamResponse, error) {
...
type UserServiceServer interface {
	...
	FetchData(*StreamRequest, UserService_FetchDataServer) error
}
...
func (*UnimplementedUserServiceServer) FetchData(*StreamRequest, UserService_FetchDataServer) error {
...
func _UserService_FetchData_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(UserServiceServer).FetchData(m, &userServiceFetchDataServer{stream})
}

type UserService_FetchDataServer interface {
	Send(*StreamResponse) error
	grpc.ServerStream
}

type userServiceFetchDataServer struct {
	grpc.ServerStream
}

func (x *userServiceFetchDataServer) Send(m *StreamResponse) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _UserService_FetchData_Handler,
			ServerStreams: true,
		},
	},
